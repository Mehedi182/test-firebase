                ...
                {mockBudgets.map(budget => {
                    ...
                    return (
                        <Card key={budget.id}>
                            ...
                            <CardContent>
                                <Progress value={Math.min(progress, 100)} className={cn(overspent && "[&>div]:bg-destructive")} />
                                <p className={cn("text-sm mt-2", overspent ? "text-destructive" : "text-muted-foreground")}>
                                    {overspent 
